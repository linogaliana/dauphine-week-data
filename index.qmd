...
author: |
    Lino Galiana
institute: |
    **[[Lino Galiana](https://www.linogaliana.fr/)]{.blue2}** (_Insee_)
#date: 06-09-2023
slide-number: true
footer: |
  **_PSL Data Week_**
...
3. Création d'un _pipeline_ sur données de transactions immobilières ;
4. Mise en production par le biais d'une API
...
- Un _pipeline_ bien pensé est facile à mettre en production
...
- En 6 heures on a:
    ...
    - Créé un _pipeline_ fonctionnel de _machine learning_,
...
- On peut maintenant se concentrer sur l'amélioration de la qualité du modèle:
    - Ouvre vers le `MLOps`: combiner modèle en production, modèle en développement, etc.
    - Enjeux de _monitoring_ de la qualité
